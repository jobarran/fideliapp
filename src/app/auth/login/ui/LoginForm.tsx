                    ...
                    <div className="overflow-auto max-h-[70vh]">
                        <form action={dispatch} className="space-y-3">
                            <div className="my-3">
                                ...
                                <input className="px-4 w-full border-1 py-2 rounded-md text-sm outline-none" type="email" name="email" id='auth-email' placeholder="email" required />
                            </div>
                            <div className="mt-5">
                                <label className="block text-md mb-2" htmlFor="password">Contraseña</label>
                                <input className="px-4 w-full border-1 py-2 rounded-md text-sm outline-none" type="password" name="password" id='auth-password' placeholder="contraseña" />
                            </div>
                            ...
                            <LoginButton />
                            <div className="flex space-x-2 justify-center items-end bg-white hover:bg-slate-100 text-slate-800 py-2 border-1 rounded-md transition duration-100">
