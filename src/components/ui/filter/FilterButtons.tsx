...
export const FilterButtons = ({ filters, handleClearFilters, setFilterModalData }: Props) => {
  ...
  return (
    <div className="flex justify-center gap-2">
      <div className="relative inline-flex w-fit">
        <button
          className="flex items-center p-1 rounded-lg border-1 hover:bg-gray-200 focus:outline-none"
